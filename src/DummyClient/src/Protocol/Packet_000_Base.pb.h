...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Packet_5f000_5fBase_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Packet_5f000_5fBase_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Packet_5f000_5fBase_2eproto
...
struct TableStruct_Packet_5f000_5fBase_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Packet_5f000_5fBase_2eproto;
namespace Protocol {
class C_ENTER;
...
extern S_SERVERTIMEDefaultTypeInternal _S_SERVERTIME_default_instance_;
class S_TEST;
...
template<> ::Protocol::S_SERVERTIME* Arena::CreateMaybeMessage<::Protocol::S_SERVERTIME>(Arena*);
...
class C_HEARTBEAT final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.C_HEARTBEAT) */ {
 public:
  ...
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const C_HEARTBEAT& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
class S_SERVERTIME final :
 ...
 public:
  inline S_SERVERTIME() : S_SERVERTIME(nullptr) {}
  ~S_SERVERTIME() override;
  explicit PROTOBUF_CONSTEXPR S_SERVERTIME(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_SERVERTIME(const S_SERVERTIME& from);
  S_SERVERTIME(S_SERVERTIME&& from) noexcept
    : S_SERVERTIME() {
    *this = ::std::move(from);
  }

  inline S_SERVERTIME& operator=(const S_SERVERTIME& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_SERVERTIME& operator=(S_SERVERTIME&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_SERVERTIME& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_SERVERTIME* internal_default_instance() {
    return reinterpret_cast<const S_SERVERTIME*>(
  ...
  inline void Swap(S_SERVERTIME* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_SERVERTIME* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_SERVERTIME* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_SERVERTIME>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_SERVERTIME& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_SERVERTIME& from) {
    S_SERVERTIME::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_SERVERTIME* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_SERVERTIME";
  }
  protected:
  explicit S_SERVERTIME(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.S_SERVERTIME)
 private:
  class _Internal;
...
// int64 tick = 1;
inline void C_PING::clear_tick() {
  _impl_.tick_ = int64_t{0};
}
inline int64_t C_PING::_internal_tick() const {
  return _impl_.tick_;
}
inline int64_t C_PING::tick() const {
  // @@protoc_insertion_point(field_get:Protocol.C_PING.tick)
  return _internal_tick();
}
inline void C_PING::_internal_set_tick(int64_t value) {
  
  _impl_.tick_ = value;
}
inline void C_PING::set_tick(int64_t value) {
...
inline int64_t S_PING::_internal_tick() const {
  return _impl_.tick_;
}
inline int64_t S_PING::tick() const {
  // @@protoc_insertion_point(field_get:Protocol.S_PING.tick)
  return _internal_tick();
}
inline void S_PING::_internal_set_tick(int64_t value) {
...
// int64 tick = 1;
inline void S_SERVERTIME::clear_tick() {
  _impl_.tick_ = int64_t{0};
}
inline int64_t S_SERVERTIME::_internal_tick() const {
  return _impl_.tick_;
}
inline int64_t S_SERVERTIME::tick() const {
  // @@protoc_insertion_point(field_get:Protocol.S_SERVERTIME.tick)
  return _internal_tick();
}
inline void S_SERVERTIME::_internal_set_tick(int64_t value) {
  
  _impl_.tick_ = value;
}
inline void S_SERVERTIME::set_tick(int64_t value) {
  _internal_set_tick(value);
  // @@protoc_insertion_point(field_set:Protocol.S_SERVERTIME.tick)
}
...
// string msg = 1;
inline void S_TEST::clear_msg() {
  _impl_.msg_.ClearToEmpty();
}
inline const std::string& S_TEST::msg() const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void S_TEST::set_msg(ArgT0&& arg0, ArgT... args) {
 
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.S_TEST.msg)
}
inline std::string* S_TEST::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:Protocol.S_TEST.msg)
  return _s;
}
inline const std::string& S_TEST::_internal_msg() const {
  return _impl_.msg_.Get();
}
inline void S_TEST::_internal_set_msg(const std::string& value) {
  
  _impl_.msg_.Set(value, GetArenaForAllocation());
}
inline std::string* S_TEST::_internal_mutable_msg() {
  
  return _impl_.msg_.Mutable(GetArenaForAllocation());
}
inline std::string* S_TEST::release_msg() {
  // @@protoc_insertion_point(field_release:Protocol.S_TEST.msg)
  return _impl_.msg_.Release();
}
inline void S_TEST::set_allocated_msg(std::string* msg) {
  if (msg != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_TEST.msg)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Packet_5f000_5fBase_2eproto
